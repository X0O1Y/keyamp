...
(when (display-graphic-p)
  ...
  (setq frame-title-format
        (list
         '(:eval (substring (mu4e--modeline-string) 0 2))
...
(setq-default header-line-format
              (list
               ...
               ;; flykeys mode indicator
               (when t
                 '(:eval (propertize mode-line-front-space 'face '(:height 125))))
...
(defun repeat-message-short (msg)
  ...
  (message (concat (propertize " 🔵 " 'face '(:height 125)) (substring msg 18))))
#+end_src
