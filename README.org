...
(when (string-equal system-type "darwin")
  ...
  (define-key key-translation-map (kbd "s-a")        (kbd "C-_"))
  (define-key key-translation-map (kbd "s-<escape>") (kbd "C-<escape>"))
  (define-key key-translation-map (kbd "s-'")        (kbd "C-t"))
  (define-key key-translation-map (kbd "s-k")        (kbd "C-v"))
  (define-key key-translation-map (kbd "s-e")        (kbd "C-d"))
  (define-key key-translation-map (kbd "s-.")        (kbd "C-h"))
  ...
  (define-key key-translation-map (kbd "s-l")        (kbd "C-u"))
  (define-key key-translation-map (kbd "s-b")        (kbd "C-q"))
  (define-key key-translation-map (kbd "s-j")        (kbd "C-c"))

  (global-set-key (kbd "s-<f7>")  'emms-seek-backward-or-previous)
  (global-set-key (kbd "s-<f8>")  'emms-pause)
  (global-set-key (kbd "s-<f9>")  'emms-seek-forward-or-next)
  ;;
  )
  #+end_src
